...
export default function Agenda({
  ...
  useEffect(() => {
    ...
    const fallbackWorkers = [
      { id: "w1", firstName: "Adriana", lastName: "Paz", roleTitle: "Estilista", workingHours: { monday: { start: "09:00", end: "20:00" }, tuesday: { start: "09:00", end: "20:00" }, wednesday: { start: "09:00", end: "20:00" }, thursday: { start: "09:00", end: "20:00" }, friday: { start: "09:00", end: "20:00" }, saturday: { start: "09:00", end: "20:00" } } },
      { id: "w2", firstName: "María", lastName: "Antonieta", roleTitle: "Manicurista", workingHours: { monday: { start: "09:00", end: "20:00" }, tuesday: { start: "09:00", end: "20:00" }, wednesday: { start: "09:00", end: "20:00" }, thursday: { start: "09:00", end: "20:00" }, friday: { start: "09:00", end: "20:00" }, saturday: { start: "09:00", end: "20:00" } } },
      { id: "w3", firstName: "Valentina", lastName: "R.", roleTitle: "Esteticista", workingHours: { monday: { start: "09:00", end: "20:00" }, tuesday: { start: "09:00", end: "20:00" }, wednesday: { start: "09:00", end: "20:00" }, thursday: { start: "09:00", end: "20:00" }, friday: { start: "09:00", end: "20:00" }, saturday: { start: "09:00", end: "20:00" } } },
      { id: "w4", firstName: "Daniela", lastName: "C.", roleTitle: "Cosmetóloga", workingHours: { monday: { start: "09:00", end: "20:00" }, tuesday: { start: "09:00", end: "20:00" }, wednesday: { start: "09:00", end: "20:00" }, thursday: { start: "09:00", end: "20:00" }, friday: { start: "09:00", end: "20:00" }, saturday: { start: "09:00", end: "20:00" } } }
    ];
