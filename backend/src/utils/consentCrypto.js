...
const SECRET = process.env.JWT_SECRET || "consent-encryption-secret-key-aura-32";
const ENCRYPTION_KEY = crypto.scryptSync(process.env.ENCRYPTION_KEY || SECRET, "consent-salt", 32);
const IV_LENGTH = 16;
